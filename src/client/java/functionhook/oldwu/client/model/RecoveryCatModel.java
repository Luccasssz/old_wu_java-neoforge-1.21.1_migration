 ...
 * 姿态（弓背等）已烘焙在几何体中，这里只做轻微起伏动态。
 */
public class RecoveryCatModel extends OldWuCatModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Old_Wu_java.id("cat_recovery"), "main");
